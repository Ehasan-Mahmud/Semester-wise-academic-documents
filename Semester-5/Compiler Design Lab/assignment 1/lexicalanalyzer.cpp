...
void classifyTokens(const vector<string>& tokens) {
    vector<string> foundKeywords, foundIdentifiers, foundConstants, foundOperators;

    for (const string& token : tokens) {
        if (isKeyword(token)) {
            foundKeywords.push_back(token);
        } else if (isOperator(token)) {
            foundOperators.push_back(token);
    ...
    cout << "Keyword: ";
    for (const auto& k : foundKeywords) cout << k << ", ";
    cout << endl;

    cout << "Identifier: ";
    for (const auto& i : foundIdentifiers) cout << i << ", ";
    cout << endl;
    ...
    cout << "Constant: ";
    for (const auto& c : foundConstants) cout << c << ", ";
    cout << endl;
}
